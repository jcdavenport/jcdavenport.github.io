...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [-10991695.479353, 3414861.645331, -10940884.374357, 3450736.782791], maxZoom: 28, minZoom: 1
    })
});
...
map.getView().fit([-10991695.479353, 3414861.645331, -10940884.374357, 3450736.782791], map.getSize());
